...
BEGIN
  ...
  INSERT INTO auth.users (
    ...
    (admin_uuid, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
     ...
     jsonb_build_object('full_name', 'System Admin', 'role', 'system_admin', 'initials', 'SA'),
     jsonb_build_object('provider', 'email', 'providers', ARRAY['email']::TEXT[]),
     false, false, '', null, '', null, '', '', null, '', 0, '', null, null, '', '', null),
    (credit_uuid, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
     'j.kamau@eximbank.co.tz', crypt('CreditOfficer@2026', gen_salt('bf', 10)), now(), now(), now(),
     jsonb_build_object('full_name', 'J. Kamau', 'role', 'credit_officer', 'initials', 'JK'),
     jsonb_build_object('provider', 'email', 'providers', ARRAY['email']::TEXT[]),
     false, false, '', null, '', null, '', '', null, '', 0, '', null, null, '', '', null),
    (legal_uuid, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
     'a.mwangi@eximbank.co.tz', crypt('LegalOfficer@2026', gen_salt('bf', 10)), now(), now(), now(),
     jsonb_build_object('full_name', 'A. Mwangi', 'role', 'legal_officer', 'initials', 'AM'),
     jsonb_build_object('provider', 'email', 'providers', ARRAY['email']::TEXT[]),
     false, false, '', null, '', null, '', '', null, '', 0, '', null, null, '', '', null),
    (officer_uuid, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
     'p.ochieng@eximbank.co.tz', crypt('CreditOfficer@2026', gen_salt('bf', 10)), now(), now(), now(),
     jsonb_build_object('full_name', 'P. Ochieng', 'role', 'credit_officer', 'initials', 'PO'),
     jsonb_build_object('provider', 'email', 'providers', ARRAY['email']::TEXT[]),
     false, false, '', null, '', null, '', '', null, '', 0, '', null, null, '', '', null)
  ON CONFLICT (id) DO NOTHING;
  ...
  INSERT INTO public.collateral_records (
    ...
    (col1_uuid, 'col-0312', 'Coastal Traders Co.', 'OBL-2024-0441', 'Mortgage'::public.collateral_type,
     ...
     'Lands Registry'::public.registry_type, '14 Apr 2026', '26 May 2026', 'J. Kamau', true, 31, credit_uuid),
    (col2_uuid, 'col-0311', 'Arusha Coffee Growers', 'OBL-2023-0812', 'FDR'::public.collateral_type,
     ...
     'N/A'::public.registry_type, '10 Apr 2026', '', 'S. Ndege', false, null, credit_uuid),
    (col3_uuid, 'col-0310', 'Dodoma Real Estate Ltd', 'OBL-2022-0334', 'Mortgage'::public.collateral_type,
     ...
     'Lands Registry'::public.registry_type, '02 Mar 2026', '13 Apr 2026', 'A. Mwangi', true, null, legal_uuid),
    (col4_uuid, 'col-0309', 'Mbeya Mining Corp.', 'OBL-2023-1107', 'Debenture'::public.collateral_type,
     ...
     'BRELA'::public.registry_type, '15 Feb 2026', '29 Mar 2026', 'A. Mwangi', true, null, legal_uuid),
    (col5_uuid, 'col-0308', 'Kilimanjaro Logistics', 'OBL-2024-0229', 'Motor Vehicle'::public.collateral_type,
     ...
     'TRA'::public.registry_type, '28 Jan 2026', '11 Mar 2026', 'P. Ochieng', true, null, officer_uuid),
    (col6_uuid, 'col-0307', 'DSE Listed Holdings Ltd', 'OBL-2023-0594', 'Shares (DSE)'::public.collateral_type,
     ...
     'DSE'::public.registry_type, '18 Apr 2026', '30 May 2026', 'J. Kamau', true, 35, credit_uuid),
    (col7_uuid, 'col-0306', 'Zanzibar Tourism Group', 'OBL-2022-0878', 'Guarantee'::public.collateral_type,
     ...
     'N/A'::public.registry_type, '05 Dec 2025', '', 'S. Ndege', false, null, credit_uuid),
    (col8_uuid, 'col-0305', 'Tanga Steel Mills', 'OBL-2023-0712', 'Shares (DSE)'::public.collateral_type,
     ...
     'DSE'::public.registry_type, '20 Apr 2026', '01 Jun 2026', 'J. Kamau', true, 37, credit_uuid),
    (col9_uuid, 'col-0103', 'Zanzibar Spice Exports', 'OBL-2024-0099', 'Ship/Vessel'::public.collateral_type,
     ...
     'TASAC'::public.registry_type, '22 Mar 2026', '22 Apr 2026', 'S. Ndege', true, -3, officer_uuid),
    (col10_uuid, 'col-0091', 'Dar Transport Holdings', 'OBL-2024-0155', 'Motor Vehicle'::public.collateral_type,
     ...
     'TRA'::public.registry_type, '20 Mar 2026', '20 Apr 2026', 'J. Kamau', true, -5, credit_uuid),
    (col11_uuid, 'col-0078', 'Mwanza Fishing Co.', 'OBL-2023-0488', 'Mortgage'::public.collateral_type,
     ...
     'Lands Registry'::public.registry_type, '18 Mar 2026', '18 Apr 2026', 'P. Ochieng', true, -7, officer_uuid),
    (col12_uuid, 'col-0041', 'Karibu Enterprises Ltd', 'OBL-2022-0211', 'Debenture'::public.collateral_type,
     ...
     'BRELA'::public.registry_type, '01 Mar 2026', '13 Apr 2026', 'J. Kamau', true, -12, credit_uuid)
  ...
  INSERT INTO public.audit_logs (
    ...
    (gen_random_uuid(), col4_uuid, 'col-0289', 'perfected'::public.audit_action,
     'Collateral col-0289 perfected at BRELA', 'Karibu Textiles Ltd · Debenture', legal_uuid, 'A. Mwangi'),
    (gen_random_uuid(), col1_uuid, 'col-0312', 'created'::public.audit_action,
     'New collateral registered: col-0312', 'Coastal Traders Co. · Mortgage · TSh 780M', credit_uuid, 'J. Kamau'),
    ...
    (gen_random_uuid(), col3_uuid, 'col-0298', 'submitted'::public.audit_action,
     'Lands Registry submission filed', 'col-0298 · Mwanza Holdings · Mortgage', officer_uuid, 'P. Ochieng'),
    (gen_random_uuid(), col10_uuid, 'col-0271', 'perfected'::public.audit_action,
     'TRA registration confirmed: col-0271', 'Dar Transport Holdings · Motor Vehicle', legal_uuid, 'A. Mwangi'),
    (gen_random_uuid(), col2_uuid, 'col-0311', 'created'::public.audit_action,
     'New collateral registered: col-0311', 'Arusha Coffee Growers · FDR · TSh 420M', credit_uuid, 'S. Ndege'),
    (gen_random_uuid(), col8_uuid, 'col-0305', 'submitted'::public.audit_action,
     'DSE share pledge registered', 'col-0305 · Tanga Steel Mills · Shares', credit_uuid, 'J. Kamau'),
    (gen_random_uuid(), col7_uuid, 'col-0244', 'released'::public.audit_action,
     'Collateral released: col-0244', 'Kilimanjaro Farms Ltd · Mortgage · Facility settled', legal_uuid, 'A. Mwangi')
  ON CONFLICT (id) DO NOTHING;
