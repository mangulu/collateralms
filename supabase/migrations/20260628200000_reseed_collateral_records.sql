-- ============================================================
-- CollateralMS — Force Re-seed Collateral Records
-- Runs unconditionally to ensure records exist in production
-- ============================================================
...
BEGIN
  ...
  IF officer_uuid IS NULL THEN SELECT id INTO officer_uuid FROM public.user_profiles LIMIT 1; END IF;
  ...
  INSERT INTO public.collateral_records (
    ...
    (gen_random_uuid(), 'col-0312', 'Coastal Traders Co.', 'OBL-2024-0441', 'Mortgage'::public.collateral_type,
    ...
    (gen_random_uuid(), 'col-0311', 'Arusha Coffee Growers', 'OBL-2023-0812', 'FDR'::public.collateral_type,
    ...
    (gen_random_uuid(), 'col-0310', 'Dodoma Real Estate Ltd', 'OBL-2022-0334', 'Mortgage'::public.collateral_type,
    ...
    (gen_random_uuid(), 'col-0309', 'Mbeya Mining Corp.', 'OBL-2023-1107', 'Debenture'::public.collateral_type,
    ...
    (gen_random_uuid(), 'col-0308', 'Kilimanjaro Logistics', 'OBL-2024-0229', 'Motor Vehicle'::public.collateral_type,
    ...
    (gen_random_uuid(), 'col-0307', 'DSE Listed Holdings Ltd', 'OBL-2023-0594', 'Shares (DSE)'::public.collateral_type,
    ...
    (gen_random_uuid(), 'col-0306', 'Zanzibar Tourism Group', 'OBL-2022-0878', 'Guarantee'::public.collateral_type,
    ...
    (gen_random_uuid(), 'col-0305', 'Tanga Steel Mills', 'OBL-2023-0712', 'Shares (DSE)'::public.collateral_type,
    ...
    (gen_random_uuid(), 'col-0103', 'Zanzibar Spice Exports', 'OBL-2024-0099', 'Ship/Vessel'::public.collateral_type,
    ...
    (gen_random_uuid(), 'col-0091', 'Dar Transport Holdings', 'OBL-2024-0155', 'Motor Vehicle'::public.collateral_type,
    ...
    (gen_random_uuid(), 'col-0078', 'Mwanza Fishing Co.', 'OBL-2023-0488', 'Mortgage'::public.collateral_type,
    ...
    (gen_random_uuid(), 'col-0041', 'Karibu Enterprises Ltd', 'OBL-2022-0211', 'Debenture'::public.collateral_type,
