...
const NAV_INDEX: NavResult[] = [
  ...
  { id: 'n-col-docs', kind: 'screen', module: 'Collaterals', moduleId: 'collaterals', label: 'Documents Library', description: 'Manage documents attached to collaterals', href: '/collateral-documents', icon: Files, keywords: ['documents', 'files', 'attachments'] },
  ...
  { id: 'n-arc-heatmap', kind: 'screen', module: 'Archive', moduleId: 'archive', label: 'Occupancy Heatmap', description: 'Vault room/cabinet/slot occupancy and capacity alerts', href: '/archive/occupancy-heatmap', icon: Flame, keywords: ['occupancy', 'heatmap', 'capacity', 'vault'] },
