    ...
    groups: [
      {
        ...
        items: [
          ...
          { label: 'Compliance Trail', icon: DatabaseZap, href: '/audit-trail', permission: PERMISSIONS.AUDIT_LOG_VIEW },
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Disposal Queue', icon: Trash2, href: '/archive/disposal-queue', permission: PERMISSIONS.COLLATERAL_VIEW },
        ],
      },
      {
        label: 'Workflow',
