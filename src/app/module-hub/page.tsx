...
const modules: ModuleCard[] = [
  {
    id: 'collaterals',
    title: 'Collaterals',
    description: 'Manage collateral registry, documents, approval workflows, and bulk operations.',
    icon: FolderOpen,
  ...
  },
  {
    ...
    description: 'Monitor deadline reminders, alert thresholds, and notification delivery logs.',
    icon: Bell,
    href: '/notifications-hub',
    color: '#B45309',
    bgGradient: 'linear-gradient(135deg, #FFFBEB 0%, #FEF3C7 60%, #FDE68A 100%)',
    iconBg: '#D97706',
    stats: 'Reminders · Thresholds · Inbox',
    requiredPermission: PERMISSIONS.DASHBOARD_VIEW,
  },
  {
    id: 'reports',
    title: 'Reports',
    description: 'Generate custom reports, performance exports, and regulatory dashboards.',
    icon: BarChart2,
    href: '/reports',
    color: '#065F46',
    bgGradient: 'linear-gradient(135deg, #ECFDF5 0%, #D1FAE5 60%, #A7F3D0 100%)',
    iconBg: '#059669',
    stats: 'Custom · Export · Regulatory',
    requiredPermission: PERMISSIONS.REPORTS_VIEW,
  },
  {
    id: 'audit',
    title: 'Audit & Compliance',
    description: 'Full audit trails, compliance rules, live activity streams, and audit reports.',
    icon: ShieldCheck,
    href: '/audit-center',
    color: '#9D174D',
    bgGradient: 'linear-gradient(135deg, #FFF1F2 0%, #FFE4E6 60%, #FECDD3 100%)',
    iconBg: '#E11D48',
    stats: 'Trails · Rules · Reports',
    requiredPermission: PERMISSIONS.AUDIT_LOG_VIEW,
  },
  {
    id: 'administration',
    title: 'Administration',
    description: 'User management, officer permissions, system settings, and client bank accounts.',
    icon: Settings,
