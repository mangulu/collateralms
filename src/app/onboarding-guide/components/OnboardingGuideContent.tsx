...
const MODULES: ModuleGuide[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'SMS Alerts', href: '/alerts-inbox', icon: Inbox, description: 'Triage the SMS alerts sent for collateral events, overdue items, and threshold breaches.' },
    ...
    journeys: [
      {
        ...
        steps: [
          ...
          { action: 'Confirm the alert clears after resubmission', where: 'SMS Alerts', href: '/alerts-inbox' },
        ],
      },
    ],
    shortcuts: [
      { label: 'Notifications', href: '/notifications-hub', icon: Bell, description: 'System notifications' },
      { label: 'SMS Alerts', href: '/alerts-inbox', icon: Inbox, description: 'SMS alerts sent to you' },
