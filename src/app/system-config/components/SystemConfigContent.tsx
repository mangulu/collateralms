...
export default function SystemConfigContent() {
  ...
  const loadConfigs = useCallback(async () => {
    ...
    } finally {setLoading(false);}}, [applyBrandCssVars]);useEffect(() => {loadConfigs();}, [loadConfigs]);const handleChange = (category: ConfigCategory, key: string, value: unknown) => {setLocalValues((prev) => ({ ...prev, [category]: { ...prev[category], [key]: value }
      }));
