  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-bold" style={{ color: 'var(--izou-secondary)', fontFamily: 'DM Sans, sans-serif' }}>Vault Reconciliation</h1>
          <p className="text-sm mt-0.5" style={{ color: 'var(--izou-muted)' }}>Periodic stock-takes confirming physical vault contents match system records</p>
        </div>
