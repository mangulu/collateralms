...
const ROLE_GUIDES: RoleGuide[] = [
  {
    ...
    screens: [
      ...
      { screen: 'Documents Library', icon: Files, actions: ['View', 'Upload'], notes: 'Attach documents to collateral records.' },
      ...
      { screen: 'SMS Alerts', icon: Inbox, actions: ['View'], notes: 'View incoming SMS alerts for assigned collateral.' },
  ...
  },
  {
    ...
    screens: [
      ...
      { screen: 'Documents Library', icon: Files, actions: ['View', 'Upload', 'Manage Security Pocket'], notes: 'Review attached documents and manage the Security Pocket.' },
      ...
      { screen: 'SMS Alerts', icon: Inbox, actions: ['View'], notes: 'View SMS alerts for collateral under review.' },
    ...
    workflows: [
      ...
      { step: 5, title: 'Manage Security Pocket', description: 'For approved collateral, go to Documents Library → Security Pocket tab to record the physical custody location of original documents.' },
  ...
  },
  {
    ...
    screens: [
      ...
      { screen: 'Documents Library', icon: Files, actions: ['View', 'Upload', 'Manage', 'Security Pocket'], notes: 'Full document management access.' },
