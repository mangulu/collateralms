...
const ROLE_GUIDES: RoleGuide[] = [
  {
    ...
    screens: [
      ...
      { screen: 'Obligors', icon: Users, actions: ['View', 'Create', 'Edit'], notes: 'Manage borrower/obligor profiles and their linked collateral.' },
      { screen: 'Loan Facilities', icon: Landmark, actions: ['View', 'Create', 'Edit'], notes: 'Register and manage loan facilities linked to obligors.' },
  ...
  },
  {
    ...
    screens: [
      ...
      { screen: 'Release Approval', icon: Unlock, actions: ['View', 'Approve', 'Reject'], notes: 'Review and approve collateral release requests.' },
    ...
    workflows: [
      ...
      { step: 6, title: 'Process Document Approvals', description: 'Check the Document Approval screen for any documents awaiting review. Approve or return with comments.' },
    ],
    tips: [
  ...
  },
  {
    ...
    screens: [
      ...
      { screen: 'Obligors', icon: Users, actions: ['View', 'Edit'], notes: 'View and manage all obligor profiles.' },
      { screen: 'Loan Facilities', icon: Landmark, actions: ['View', 'Edit'], notes: 'View and manage all loan facilities.' },
      ...
      { screen: 'Release Approval', icon: Unlock, actions: ['View', 'Approve', 'Reject'], notes: 'Approve collateral release requests.' },
