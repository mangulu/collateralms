...
import { BookOpen, ArrowRight, ShieldCheck, Scale, BarChart2, Settings2 } from 'lucide-react';
        ...
        >
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-blue-200 text-sm font-medium">Role Guides</span>
            </div>
            ...
            <p className="text-blue-200 text-sm max-w-2xl leading-relaxed">
              Each guide is tailored to your role — covering your module map, core task walkthroughs, workflow actions, and tips specific to what you do every day.
            </p>
          </div>
        </div>
