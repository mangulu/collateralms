...
const TEST_PHASES: TestPhase[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { step: 4, action: 'Open AI Fraud Prevention and check the fraud scan for the test collateral', where: 'AI Fraud Prevention', href: '/fraud-prevention', expect: 'Fraud scan results display for the test collateral — not a blank screen.' },
      { step: 5, action: 'Open AI Risk Assessment and check the risk score for the test collateral', where: 'AI Risk Assessment', href: '/risk-assessment', expect: 'Risk score displays for the test collateral — not a blank screen.' },
      { step: 6, action: 'Approve the perfection submission', where: 'Perfection Workflow', href: '/perfection-workflow', expect: 'Status updates to "Perfected". Credit Officer receives a notification. Audit log entry created.' },
      { step: 7, action: 'Verify the collateral status in the registry', where: 'Collateral Registry', href: '/collateral-management', expect: 'Collateral status shows "Perfected". Perfection date is recorded.' },
    ],
  },
  {
    id: 'phase-4',
  ...
  },
  {
    ...
    steps: [
      ...
      { step: 3, action: 'Open AI Risk Assessment and run a risk assessment', where: 'AI Risk Assessment', href: '/risk-assessment', expect: 'OpenAI returns a risk score. Results display in the UI within 10 seconds.' },
