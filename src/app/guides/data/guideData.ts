...
export const MANAGER_GUIDE: RoleGuide = {
  ...
  modules: [
    ...
    { label: 'Compliance Trail', href: '/audit-trail', icon: DatabaseZap, why: 'Searchable audit database for regulatory reviews and internal investigations.' },
  ...
  tasks: [
    ...
    },
    {
      ...
      steps: [
        ...
        { action: 'Verify the change is logged in the Compliance Trail', where: 'Compliance Trail', href: '/audit-trail' },
      ],
    },
    {
      ...
      steps: [
        ...
        { action: 'Execute the migration and verify results in the Compliance Trail', where: 'Compliance Trail', href: '/audit-trail' },
      ],
    },
  ],
  tips: [
